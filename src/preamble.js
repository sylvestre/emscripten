...
function SAFE_HEAP_ACCESS(dest, type, store, ignore, storeValue) {
  ...
  assert(dest > 0, 'segmentation fault: null pointer, or below normal memory');
...
var STATIC_BASE = 0, STATICTOP = 0; // static area
...
var nullString = '(null)';
allocate(intArrayFromString(nullString), 'i8', ALLOC_NONE, 0);
